      ...
      <main className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md bg-white rounded-3xl p-8 sm:p-10 shadow-2xl border border-[#CCFBF1] space-y-7 relative">
          ...
          <div className="space-y-2">
            <h1 className="text-3xl font-black text-[#0F766E]">Sign in</h1>
            <p className="text-xs sm:text-sm text-slate-500">
              Masuk ke akun pelamar Anda untuk mengelola lamaran &amp; asesmen PO-FIT.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              type="button"
              className="w-full py-3.5 px-4 rounded-2xl border-2 border-slate-200 hover:border-[#0F766E] bg-white hover:bg-[#F4FDFB] text-slate-700 font-bold text-xs sm:text-sm transition-all flex items-center justify-center gap-3 shadow-2xs group"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1">
              <div className="flex items-center justify-between text-xs font-bold text-slate-700">
                ...
                <button type="button" className="text-[#0F766E] hover:underline flex items-center gap-1">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white border-2 border-slate-300 focus:border-[#0F766E] focus:ring-2 focus:ring-teal-100 rounded-2xl text-sm outline-none transition-all"
              />
            </div>
          ...
          <div className="pt-2 text-center text-xs text-slate-600 font-medium">
            ...
            <Link href="/pelamar/register" className="font-extrabold text-[#0F766E] hover:underline">
              Register
            </Link>
          </div>

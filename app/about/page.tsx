...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans antialiased flex flex-col selection:bg-[#1A4B9F] selection:text-white transition-colors duration-300">
        ...
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-14 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-4 text-center lg:text-left">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold tracking-tighter leading-tight text-slate-900 dark:text-white">
                Menghubungkan Talenta Terbaik Indonesia dengan Peluang Karir Masa Depan
              </h1>

              <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 max-w-xl font-normal leading-relaxed mx-auto lg:mx-0">
            ...
            <div className="lg:col-span-5 flex justify-center relative">
              <div className="relative w-full max-w-[440px] aspect-[4/5] flex items-center justify-center">
                ...
                <div className="absolute inset-0 rounded-3xl bg-slate-50 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800 shadow-2xs pointer-events-none" />

                {/* Floating Analytics Glass Card 1 (Top Left) */}
                <div className="absolute top-4 -left-3 sm:-left-5 z-20 bg-white/95 dark:bg-slate-900/95 text-slate-900 dark:text-white px-3.5 py-2.5 rounded-2xl shadow-lg border border-slate-200/80 dark:border-slate-800 backdrop-blur-md flex items-center gap-2.5">
                  <div className="w-8 h-8 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200/60 dark:border-slate-700/60 flex items-center justify-center font-bold shrink-0">
                    <Brain size={16} />
                  </div>
                  <div>
                ...
                <div className="absolute bottom-6 -right-2 sm:-right-5 z-20 bg-white/95 dark:bg-slate-900/95 text-slate-900 dark:text-white px-3.5 py-2.5 rounded-2xl shadow-lg border border-slate-200/80 dark:border-slate-800 backdrop-blur-md flex items-center gap-2.5">
                  <div className="w-8 h-8 rounded-xl bg-emerald-50 dark:bg-emerald-950/60 text-emerald-600 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-900/60 flex items-center justify-center font-bold shrink-0">
                    <CheckCircle2 size={16} />
                  </div>
                  <div>
                    <p className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Seleksi Fair</p>
                    <p className="text-xs font-bold text-slate-900 dark:text-white">100% Anti-Bias</p>
                  </div>
                </div>
      ...
      <section className="bg-slate-50/60 dark:bg-slate-950 py-10 sm:py-14 border-b border-slate-100 dark:border-slate-800 transition-colors">
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-14 space-y-8">
          ...
          <div className="max-w-xl space-y-1.5">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full border border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400 text-[11px] font-medium tracking-wide shadow-2xs">
              <TrendingUp size={11} className="text-slate-400 dark:text-slate-500" />
        ...
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-14">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-5 space-y-2">
              <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full border border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400 text-[11px] font-medium tracking-wide shadow-2xs">
                <Scale size={11} className="text-slate-400 dark:text-slate-500" />
      ...
      <section className="bg-white dark:bg-slate-950 py-8 sm:py-12 transition-colors">
        <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-14">
          <div className="bg-[#1A4B9F] text-white rounded-3xl p-8 sm:p-12 text-center space-y-4 shadow-lg relative overflow-hidden">
            <div className="relative z-10 space-y-3 max-w-xl mx-auto">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tighter leading-tight text-white">
              ...
              <div className="pt-2">
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white hover:bg-blue-50 text-[#1A4B9F] font-bold text-xs sm:text-sm shadow-md transition-all cursor-pointer"
                >

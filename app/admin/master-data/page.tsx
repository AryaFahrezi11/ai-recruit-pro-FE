    ...
    <div className="space-y-6 font-sans antialiased">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-xs font-medium mt-1">Kelola data referensi seperti Kategori Pekerjaan dan Skill.</p>
        </div>
      </div>
      ...
      {activeTab === 'skill' && (
        <div className="bg-white dark:bg-slate-900 p-12 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xs flex flex-col items-center justify-center text-center">
          <Briefcase size={40} className="text-black dark:text-white mb-3" />
          <h3 className="text-base font-extrabold text-slate-900 dark:text-white mb-1">Manajemen Skill</h3>
